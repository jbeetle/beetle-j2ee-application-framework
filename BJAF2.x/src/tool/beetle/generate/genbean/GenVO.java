    ...
    public void genAttributes() { //��������Բ���
        ...
        while (it.hasNext()) {
            ...
            if (!(obj.toString().equals("tabName")) &&
                ...
                sb.append("    private ").append(attributeType).
    ...
    public void genGetters() { //�����getter����
        ...
        while (it.hasNext()) {
            ...
            if (!(obj.toString().equals("tabName")) &&
                ...
                attributeType = attributes.get(obj).toString();
                sb.append("\n");
                sb.append("    public ").append(attributeType).
                        append(" get").append(Common.fisrtCharToUpCase3(
    ...
    public void genSetters() { //�����setter����
        ...
        while (it.hasNext()) {
            ...
            if (!(obj.toString().equals("tabName")) &&
                ...
                sb.append("\n");
                sb.append("    public void set").append(Common.
                        fisrtCharToUpCase3(attributeName)).append("(").append(
                                attributeType).append(" ").
                        append(attributeName).append("){");
                sb.append("\n");
                sb.append("      this.").append(attributeName).append(" = ").
                        append(attributeName).append(";");
                sb.append("\n");
                sb.append("    }");
            }
